...
public class TesseractWrapper
{
    ...
    public string Recognize()
    {
       ...
       // _highlightedTexture = texture;
        ...
        int width = NavData.ImageData.width;
        int height = NavData.ImageData.height;
        Color32[] colors = NavData.ImageData.colors;
        ...
        for (int index = 0; index < boxes.Length; index++)
        {
            if (confidence[index] >= MinimumConfidence)
            {
                ...
                Box box = boxes[index];
               /* DrawLines(NavData.ImageData._highlightedTexture,
                            new Rect(box.x, NavData.ImageData.height - box.y - box.h, box.w, box.h),
                            Color.green);*/
            }
        }
    ...
    */
    ...
    {
        return NavData.ImageData._highlightedTexture;
    }
